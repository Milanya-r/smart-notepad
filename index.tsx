...
// This file should contain the application's source code.
// To fix the "Script error", the same full code is now present here and in index.html's inline script.
